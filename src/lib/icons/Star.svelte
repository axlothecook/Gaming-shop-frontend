...
<style lang="scss">
    ...
    @include bp.md-down {
        svg.w-2 { width: 1.5rem; }
    }
    @include bp.xs-down {
        svg.w-1-1 { width: .8rem; }
    }
</style>